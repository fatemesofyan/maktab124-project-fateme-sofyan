...
export default function CollactionSize() {
  return (
    <div className='flex flex-col justify-center items-center content-center gap-10 mt-60'>
        ...
        <div className='flex flex-row gap-20'>
            <img src="https://res.cloudinary.com/easyplant/image/upload/f_auto,q_auto,c_fill,w_690,h_440/homepage2/collections/collectionsx4.jpg" alt="collectionsx4" />
        {/* <Image
